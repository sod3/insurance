    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-2.5 mb-5">
            <div className="flex items-center">
              {/* Added descriptive alt text for SEO indexing of both names */}
              <img src="/favicon.svg" alt="InsureComparePro by youconect" className="h-8 w-8" />
            </div>
            <div>
              <span className="text-white font-extrabold text-base">InsureCompare<span className="text-[#22c55e]">Pro</span></span>
              {/* Added 'by youconect' here to establish brand authority */}
              <p className="text-[10px] text-slate-500 mt-0.5">by youconect · Independent · Unbiased · 2026</p>
            </div>
          </div>
          <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-5">
            InsureComparePro, a division of <strong>youconect</strong>, is an independent auto insurance comparison resource. We provide unbiased educational content to help American drivers find the best car insurance rates in their state.
          </p>
          <div className="flex gap-3">
            {["Compare Rates", "State Guides", "Coverage FAQ"].map(t => (
              <div key={t} className="text-[#22c55e] text-xs font-semibold hover:text-green-400 transition-colors cursor-pointer">{t} →</div>
            ))}
          </div>
        </div>
      ...
      <div className="border-t border-white/10 pt-8">
        <p className="text-slate-500 text-xs leading-relaxed mb-4">
          <strong className="text-slate-400">Advertiser Disclosure & Disclaimer:</strong> InsureComparePro is an independent comparison resource hosted on <strong>youconect.com</strong>. We are not a licensed insurance company or insurance agent. This site provides educational content only. Some links on this site may be affiliate links-we may earn a commission at no extra cost to you. Rates shown are national averages for illustration only and do not constitute a binding quote. Actual rates depend on your specific profile, state, and coverage choices. Always verify rates and coverage directly with licensed insurance providers. Last updated January 2026.
        </p>
        <div className="flex flex-wrap gap-5 text-xs text-slate-500">
          ...
          {/* Copyright now explicitly mentions the domain name for better indexing */}
          <span className="md:ml-auto text-slate-600">© 2026 InsureComparePro by youconect. All rights reserved.</span>
        </div>
      </div>
    </div>
  </footer>
